...
for(i in 1:nlayers(stk)){
  ...
  points(x = observed_mean, y = 0, pch = 23, col = "black", bg = "red", cex = 1.3)
  abline(v = random_mean, col = "blue", lty = 2, lwd = 2)
  points(x = random_mean, y = 0, pch = 23, col = "black", bg = "blue", cex = 1.3)
