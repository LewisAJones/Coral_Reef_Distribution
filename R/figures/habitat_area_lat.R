...
p1 <- ggplot() + 
  ...
  scale_fill_viridis(option = "D", direction = 1, limits = c(0, 160), breaks=seq(0, 160, by= 40), labels = seq(0, 160, by=40)) +
  ...
  labs(x = "Time (Ma)", y = expression(bold(paste("Palaeolatitude (",degree,")"))), subtitle = "LTP") +
  theme(
...
p1 <- p1 + guides(fill = guide_colourbar(ticks.colour = "black", frame.colour = "black", label = TRUE, title = expression(bold(paste("Suitable habitat area (",10^6~km^2,")",sep=""))), title.position = "top", title.hjust = 0.5, title.vjust = -9))
...
p2 <- p2 + guides(fill = guide_colourbar(ticks.colour = "black", frame.colour = "black", label = TRUE, title = expression(bold(paste("Suitable habitat area (",10^6~km^2,")",sep=""))), title.position = "top", title.hjust = 0.5, title.vjust = -9))
